                ...
                <div class="col-12">
                   <form  id="checkedCode"  action="<?php echo url .'/'.$this->folder ?>/tajhez" method="post">
                       ...
                       <div class="row justify-content-end">
                           <div class="col-auto">
                               <input  autocomplete="off" type="text" id="code_checked" onkeyup="resetForm();setTimeStamp(this)"          class="form-control" placeholder="ادخل باركود المادة" name="code" required>
