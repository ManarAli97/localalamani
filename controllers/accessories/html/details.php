                        ...
                        <div class="cart_a">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-4 col-sm-6 col-6" style="margin-bottom: 100px;">
                                    <?php if (isset($_SESSION['username_member_r']) || $this->isDirect()) { ?>
                                        <?php if ($this->phone=='true' || $this->isDirect()) {   ?>
                                        <button class="btn btn-primary addToCart" type="submit" name="submit"> اضف الى السلة<i
                                                    class="fa fa-cart-plus"></i>
                                        </button>

                                    <?php  }else{   ?>
                                    <button class="btn   addToCart" type="button"
                                            data-toggle="modal" data-target="#add_phone"> اضف الى السلة<i
                                                    class="fa fa-cart-plus"></i>
                                    </button>
                                    <?php  }  ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <button class="btn btn-primary addToCart" type="button"
                                                data-toggle="modal" data-target="#login_site"> اضف الى السلة<i
                                                    class="fa fa-cart-plus"></i>
                                        </button>
                                    <?php } ?>
                                </div>
