...
class direct extends Controller
{
	...
	public function index()
	{
		...
		if ($this->admin($this->userid)) {
			$stmt = $this->db->prepare("SELECT cart_shop.accountant,cart_shop.id_accountant_user,cart_shop.id_member_r, cart_shop.number_bill,cart_shop.top,cart_shop.date_req,cart_shop.direct,cart_shop.user_direct,register_user.id,register_user.name,register_user.phone  FROM `cart_shop` inner join register_user on register_user.id=cart_shop.id_member_r WHERE  cart_shop.`accountant` = 1 AND cart_shop.`prepared` = 1 AND  cart_shop.done_direct =0 AND  (cart_shop.`direct` =2  OR cart_shop.direct=0 )   GROUP BY cart_shop.`number_bill`,cart_shop.id_member_r   ORDER BY cart_shop.`number_bill` ASC ");
			$stmt->execute();
		} else {
			$stmt = $this->db->prepare("SELECT cart_shop.accountant,cart_shop.id_accountant_user,cart_shop.id_member_r, cart_shop.number_bill,cart_shop.top,cart_shop.date_req,cart_shop.direct,cart_shop.user_direct,register_user.id,register_user.name,register_user.phone  FROM `cart_shop` inner join register_user on register_user.id=cart_shop.id_member_r WHERE   (cart_shop.`user_direct` =? OR cart_shop.direct=0 ) AND cart_shop.`accountant` = 1 AND cart_shop.`prepared` = 1 AND  cart_shop.done_direct =0 AND (cart_shop.`direct` =2  OR cart_shop.direct=0 ) GROUP BY cart_shop.`number_bill`,cart_shop.id_member_r  ORDER BY cart_shop.`number_bill` ASC ");
...
//			$stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE  buy <> 0 AND   ( `user_direct` =? OR   `direct` = 0   )  AND  `accountant` = 0    AND  done_direct =0 AND  ( `direct` =3  OR `direct` = 0   ) AND `back_to`=0 AND `cancel`=0    AND `table`  IN ({$c})    GROUP BY `number_bill`  ORDER BY `number_bill` ASC ");
			$stmt = $this->db->prepare("SELECT cart_shop.*,register_user.name,register_user.phone,register_user.id FROM `cart_shop` INNER JOIN register_user ON register_user.id=cart_shop.id_member_r WHERE  cart_shop.buy <> 0 AND   cart_shop.`accountant` = 0   AND   cart_shop.`back_to`=0 AND cart_shop.`cancel`=0    AND cart_shop.`table`  IN ({$c})    GROUP BY cart_shop.`number_bill`,cart_shop.`id_member_r`   ORDER BY cart_shop.`number_bill` ASC ");
			$stmt->execute();
//			$stmt->execute(array($this->userid));
...
//                $row['sumbill']=$this->sunBill($row['id_member_r'],$row['number_bill']);
	...
	function  search_new()
	{
		if ($this->handleLogin())
		{
			...
			$q = '%' . $search . '%';
			$stmt = $this->db->prepare("SELECT cart_shop.accountant,cart_shop.id_member_r, cart_shop.number_bill,cart_shop.top,cart_shop.date_req,cart_shop.direct,cart_shop.user_direct,register_user.id,register_user.name,register_user.phone  FROM `cart_shop` inner join register_user on register_user.id=cart_shop.id_member_r WHERE ( register_user.name LIKE ? OR  register_user.phone LIKE ? OR cart_shop.number_bill=? ) AND  cart_shop.accountant =0   AND cart_shop.cancel=0 AND          (`prepared`=1 or prepared=0) GROUP BY cart_shop.id_member_r  LIMIT 15");
	...
	function  search_new_qr()
	{
		if ($this->handleLogin())
		{
			...
			$stmt = $this->db->prepare("SELECT cart_shop.accountant,cart_shop.id_member_r, cart_shop.number_bill,cart_shop.top,cart_shop.date_req,cart_shop.direct,cart_shop.user_direct,register_user.id,register_user.name,register_user.phone  FROM `cart_shop` inner join register_user on register_user.id=cart_shop.id_member_r WHERE register_user.uid = ?  AND  cart_shop.accountant =0   AND cart_shop.cancel=0    AND     (`prepared`=1 or prepared=0) GROUP BY cart_shop.id_member_r  LIMIT 1");
	...
	function  search_new_qr_direct3_tz()
	{
		if ($this->handleLogin())
		{
			...
			$stmt = $this->db->prepare("SELECT cart_shop.accountant,cart_shop.id_accountant_user,cart_shop.id_member_r, cart_shop.number_bill,cart_shop.top,cart_shop.date_req,cart_shop.direct,cart_shop.user_direct,register_user.id,register_user.name,register_user.phone  FROM `cart_shop` inner join register_user on register_user.id=cart_shop.id_member_r WHERE register_user.uid = ?  AND  cart_shop.accountant =1   AND cart_shop.cancel=0    AND     (`prepared`=1 or prepared=0) GROUP BY cart_shop.id_member_r  LIMIT 1");
			$stmt->execute(array($q));
			$data=array();
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
			{
	...
	function  search_new_qr_direct2_tz()
	{
		if ($this->handleLogin())
		{
			...
			$stmt = $this->db->prepare("SELECT cart_shop.accountant,cart_shop.id_accountant_user,cart_shop.id_member_r, cart_shop.number_bill,cart_shop.top,cart_shop.date_req,cart_shop.direct,cart_shop.user_direct,register_user.id,register_user.name,register_user.phone  FROM `cart_shop` inner join register_user on register_user.id=cart_shop.id_member_r WHERE register_user.uid = ?    AND `accountant` = 1 AND `prepared` = 1 AND  done_direct =0 AND (`direct` =2  OR direct=0 )    LIMIT 1");
			$stmt->execute(array($q));
			$data=array();
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
			{
	...
	function sunBill($id,$n_bill)
	{
        ...
        $price1_normal=0;
        $xp1Offer=0;
        $stmtOffer = $this->db->prepare("SELECT  cart_shop.* FROM `cart_shop` WHERE `id_member_r` =? AND `number_bill`=?  AND `accountant`=0  AND id_offer <> 0 AND offers = 'offers' GROUP BY  `date_offer`  ORDER BY `id` DESC  ");
        ...
        $stmtNotOffer = $this->db->prepare("SELECT  cart_shop.*,SUM(number) as number FROM `cart_shop` WHERE `id_member_r` =? AND `number_bill`=? AND    `accountant`=0   AND id_offer = 0  AND offers = ''  GROUP BY  `id_item`,`table`,`code`,`color`,`number_bill`,price_type  ORDER BY `id` DESC  ");
...
//            }
 ...
 return number_format($price1Offer);
	...
	public function view_order3_account($id)
	{
		...
		$stmt = $this->db->prepare("SELECT  cart_shop.*,SUM(`number`)as number FROM `cart_shop` WHERE `id_member_r` =?  AND `accountant`=0 AND `number_bill`=?    GROUP BY   `id_item`,`table`,`code`,`number_bill`,price_type,id_offer     ");
        ...
        $stmtOffer = $this->db->prepare("SELECT  cart_shop.*,SUM(number) as number FROM `cart_shop` WHERE `id_member_r` =? AND `number_bill`=? AND    `accountant`=0   AND id_offer = 0  AND offers = ''  GROUP BY  `id_item`,`table`,`code`,`color`,`number_bill`,price_type  ORDER BY `id` DESC  ");
        $stmtOffer->execute(array($id,$number_bill));
 ...
 function processing_request3_account($id)
			...
			if (!is_numeric($id)) {
				...
				$error->index();
		        	...
		        	$number_bill = $_GET['number_bill'];
                        ...
                        $stmtChAcco = $this->db->prepare("SELECT *FROM  `cart_shop`  WHERE `number_bill` =? AND `id_member_r`=? AND `buy` = 1  AND cancel=0 ");
                        ...
                        if ($stmtChAcco->rowCount() > 0) {
				              ...
				              $price1 = (int)trim(str_replace($this->comma, '', $this->sunBill($id,$number_bill)));
								...
								while ($rowt = $stmtt->fetch(PDO::FETCH_ASSOC)) {
								 ...
								 $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `status` = 1 ,  `accountant` = 1 , `prepared` = 1 , `date_accountant`= ? , `user_id`=?,`id_accountant_user`=?,`top`=0,user_direct=?,auto_print=1  WHERE `number_bill` =? AND `buy` = ?  AND `id_member_r`=?  AND `accountant`=0");
								...
								if ($stmt2->rowCount() > 0) {
									...
									$trace = new trace();
									$trace->addtrace('cart_shop', 'محاسبة', json_encode($oldData), json_encode($newData), ' محاسبة طلب', $number_bill);
	...
	public function direct3()
    {
        ...
        $this->adminHeaderController($this->langControl('view_request'));
            ...
            $stmt = $this->db->prepare("SELECT cart_shop.*,register_user.name,register_user.phone,register_user.id FROM `cart_shop` INNER JOIN register_user ON register_user.id=cart_shop.id_member_r WHERE  cart_shop.`accountant` = 1  AND cart_shop.`prepared` = 1  AND cart_shop.cancel=0 AND cart_shop.buy <> 3 AND cart_shop.`table`  IN ({$c})   GROUP BY cart_shop.`number_bill`,cart_shop.`id_member_r`  ORDER BY cart_shop.`number_bill` ASC ");
            $stmt->execute();
    ...
    public function back_to()
    {
        ...
        if ($this->admin($this->userid))
        {
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE  `accountant` = 1 AND `prepared` = 1 AND  done_direct =0 AND `direct` =3  AND `back_to`=2 GROUP BY `id_member_r`  ORDER BY `date_req` ASC ");
            $stmt->execute();
        }else
        {
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `user_direct` =?  AND `accountant` = 1 AND `prepared` = 1 AND  done_direct =0 AND `direct` =3 AND `back_to`=2  GROUP BY `id_member_r`  ORDER BY `date_req` ASC ");
            $stmt->execute(array($this->userid));
        }
    ...
    {
        $stmt = $this->db->prepare("SELECT * FROM  `cart_shop`  WHERE `id_member_r` = ? AND `buy` = 1 AND  `status` = 0  ");
        $stmt->execute(array($id));
    ...
    public function all_notification_buy()
    {
        ...
        if ($this->admin($this->userid)) {
            ...
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `accountant` =1 AND `prepared` = 1   AND  done_direct =0 AND  ( `direct` =2  OR `direct` =0   )  AND number_bill <> 0  GROUP BY `id_member_r`");
            $stmt->execute();
        }else
        {
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE    ( `user_direct`=? OR  `direct` = 0 )  AND `accountant` = 1 AND `prepared` =1 AND  done_direct =0 AND  ( `direct` =2 OR `direct` =0   )  AND number_bill <> 0 GROUP BY `id_member_r`");
            $stmt->execute(array($this->userid));
        }
    ...
    public function all_notification_buy3()
    {
            ...
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE    `accountant` =1  AND   (  `prepared` = 1  OR  `prepared` = 0 )    AND number_bill <> 0  AND `cancel`=0  AND `table`  IN ({$c})   GROUP BY `number_bill`");
            $stmt->execute(array($this->userid));

//            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE  ( `user_direct`=? OR  `direct` = 0 )   AND `accountant` =1  AND   (  `prepared` = 1  OR  `prepared` = 0 )   AND ( `direct` =3  OR `direct` =0   ) AND number_bill <> 0  AND `cancel`=0  AND `table`  IN ({$c})   GROUP BY `number_bill`");
//            $stmt->execute(array($this->userid));
...
//
//
//            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE  ( `user_direct`=? OR  `direct` = 0 )   AND `accountant` = 0 AND (  `prepared` = 1  OR  `prepared` = 0 ) AND  done_direct =0 AND ( `direct` =3  OR `direct` =0   ) AND number_bill <> 0  AND `cancel`=0  AND `table`  IN ({$c})   GROUP BY `number_bill`");
//            $stmt->execute(array($this->userid));
//


            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   buy <> 0 AND   `accountant` = 0    AND `cancel`=0  AND number_bill <> 0  AND `cancel`=0  AND `table`  IN ({$c})   GROUP BY `number_bill`");
            $stmt->execute(array($this->userid));
...
//
            ...
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE    `accountant` = 1  AND  prepared =1 AND `cancel`=0  AND number_bill <> 0   AND `table`  IN ({$c})   GROUP BY `number_bill`");
            $stmt->execute(array($this->userid));
    ...
    public function all_notification_buy3back()
    {
            ...
            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE     `accountant` = 1 AND  (  `prepared` = 1  OR  `prepared` = 0 )   AND   `back_to`=0 AND `cancel`=0  AND number_bill <> 0  AND `cancel`=0  AND `table`  IN ({$c})   GROUP BY `number_bill`");
            $stmt->execute();


//            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE  ( `user_direct`=? OR  `direct` = 0 )   AND `accountant` = 1 AND  (  `prepared` = 1  OR  `prepared` = 0 )  AND  done_direct =0 AND  ( `direct` =3  OR `direct` =0   )  AND `cancel`=0   AND number_bill <> 0  GROUP BY `id_member_r`");
//            $stmt->execute(array($this->userid));
...
//             $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE      `accountant` = 1 AND  (  `prepared` = 1  OR  `prepared` = 0 )   AND `table`  IN ({$c})   AND number_bill <> 0  GROUP BY `id_member_r`");
//             $stmt->execute(array($this->userid));




// //            $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE    (`user_direct` =?  OR `direct` =0   )  AND `accountant` = 1 AND  (  `prepared` = 1  OR  `prepared` = 0 )  AND  done_direct =0 AND  ( `direct` =2  OR `direct` =0   )    AND number_bill <> 0  GROUP BY `id_member_r`");
// //            $stmt->execute(array($this->userid));
...
//     11/6/2022
    	$c=implode(',',$this->catgUser);
        $stmt = $this->db->prepare("SELECT count( DISTINCT id_member_r ) as count FROM `cart_shop` WHERE      `accountant` = 1 AND  (  `prepared` = 1  OR  `prepared` = 0 )   AND `table`  IN ({$c})   AND number_bill <> 0  ");
        $stmt->execute(array());
...
//             $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE    buy <> 0 AND   `accountant` = 0    AND `cancel`=0  AND number_bill <> 0  AND `cancel`=0   AND `table`  IN ({$c})   AND number_bill <> 0  GROUP BY `number_bill`,`id_member_r`");
//             $stmt->execute(array($this->userid));
...
//     11/6/2022
        ...
        $stmt = $this->db->prepare("SELECT count( DISTINCT number_bill ) as count FROM `cart_shop` WHERE buy <> 0 AND `accountant` = 0 AND `cancel`=0 AND `cancel`=0 AND `table` IN ({$c})  ");
        $stmt->execute(array());
        $row =$stmt->fetch(PDO::FETCH_ASSOC);
        echo  $row['count'];
    }
...
//     11/6/2022
     	$c=implode(',',$this->catgUser);
		$stmt = $this->db->prepare("SELECT count( DISTINCT number_bill ) as count FROM `cart_shop` WHERE `accountant` = 1 AND `prepared` = 1 AND `cancel`=0 AND number_bill <> 0  AND `table` IN ({$c}) ");
        $stmt->execute();
		$row =$stmt->fetch(PDO::FETCH_ASSOC);
        echo  $row['count'];
    }
    ...
    {
        $stmt = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`date_req`,`mpx`,`number_bill`,`top`,`dollar_exchange` FROM `cart_shop` WHERE `id_member_r` =? AND number_bill =? AND  `code`=?  LIMIT 1  ");
    ...
    public  function view_order($id,$n_bill)
    {
        ...
        $stmtOffer = $this->db->prepare("SELECT  cart_shop.* FROM `cart_shop` WHERE  `id_member_r` =?  AND `accountant`=1 AND `number_bill`=?  AND id_offer <> 0 AND offers = 'offers' GROUP BY  `date_offer`  ORDER BY `id` DESC   ");
        $stmtOffer->execute(array($id,$number_bill));
        ...
        $stmtOffer = $this->db->prepare("SELECT  cart_shop.*,SUM(number) as number FROM `cart_shop` WHERE  `id_member_r` =?  AND `accountant`=1 AND `number_bill`=?  AND id_offer = 0  AND offers = ''  GROUP BY  `id_item`,`table`,`code`,`color`,`number_bill`,price_type   ORDER BY `id` DESC  ");
        $stmtOffer->execute(array($id,$number_bill));
	...
	{
//		$stmt = $this->db->prepare("SELECT  COALESCE(SUM(`number`),0) as number   FROM `cart_shop` WHERE `id_member_r` =? AND `code`=?   AND `number_bill`=? AND `table`=? AND `accountant`=1 AND `prepared`=? ");
...
//
		 ...
		 $stmt = $this->db->prepare("SELECT wr_prepared  FROM `cart_shop` WHERE `id_member_r` =? AND `code`=?   AND `number_bill`=? AND `table`=? AND `accountant`=1 AND `prepared`=? ");
		$stmt->execute(array($id_member_r,$code,$number_bill,$table,$p));
		 if ($stmt->rowCount() > 0)
		 {
		 	$result=$stmt->fetch(PDO::FETCH_ASSOC);
    ...
    public  function view_order3($id,$n_bill)
    {
        ...
        $stmtOffer = $this->db->prepare("SELECT  cart_shop.*  FROM `cart_shop` WHERE  `id_member_r` =?    AND `number_bill`=? AND `accountant`=1   AND id_offer <> 0 AND offers = 'offers' GROUP BY  `date_offer`  ORDER BY `id` DESC  ");
        $stmtOffer->execute(array($id,$number_bill));
        ...
        $stmtOffer = $this->db->prepare("SELECT  cart_shop.*,SUM(number) as number FROM `cart_shop` WHERE `id_member_r` =?    AND `number_bill`=? AND `accountant`=1  AND id_offer = 0  AND offers = ''  GROUP BY  `id_item`,`table`,`code`,`color`,`number_bill`,price_type   ORDER BY `id` DESC  ");
        $stmtOffer->execute(array($id,$number_bill));
    ...
    public function getAllContentFromCar($id_member_r,$number_bill)
    {
        ...
        $stmt = $this->db->prepare("SELECT  cart_shop.*,SUM(`number`)as number   FROM `cart_shop` WHERE `id_member_r` =?  AND `accountant`=1 AND `number_bill`=? GROUP BY   `id_item`,`table`,`code`,`number_bill`,price_type,id_offer   ");
        $stmt->execute(array($id_member_r,$number_bill));
        return $stmt;
    }
    ...
    public function getAllContentFromCar3($id_member_r,$number_bill)
    {
        ...
        $stmt = $this->db->prepare("SELECT  cart_shop.*,SUM(`number`)as number FROM `cart_shop` WHERE `id_member_r` =?    AND `number_bill`=? AND `accountant`=1 GROUP BY  `id_item`,`table`,`code`,`number_bill`,price_type,id_offer    ");
        $stmt->execute(array($id_member_r,$number_bill));
        return $stmt;
    }
  ...
  /*  public function getAllContentFromCar3Tajhez($id_member_r,$number_bill,$table,$code,$name_color)
    {
        ...
        $stmt = $this->db->prepare("SELECT  cart_shop.*,SUM(`number`)as number FROM `cart_shop` WHERE `id_member_r` =?    AND `number_bill`=? AND `table`=? AND `code`=?  GROUP BY  `id_item`,`table`,`code`,`number_bill`,price_type,id_offer   ORDER BY `id` DESC  ");
...
*/
    ...
    public function getAllContentFromCar3Backto($id_member_r,$number_bill)
    {
        ...
        $stmt = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`date_req`,`mpx`,`number_bill` ,`id_member_r`,`prepared`,`dollar_exchange` FROM `cart_shop` WHERE `id_member_r` =?  AND `accountant`=1 AND `number_bill`=? GROUP BY  `id_item`,`table`,`code`,`number_bill`,price_type,id_offer   ORDER BY `id` DESC  ");
        $stmt->execute(array($id_member_r,$number_bill));
        return $stmt;
    }
    ...
    function processing_request($id)
    {
        if ($this->handleLogin()) {
            ...
            $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `status` = 1 ,  `prepared` = 1 , `date_prepared`= ? , `user_id`=? WHERE `number_bill` =? AND `buy` = ?  AND `id_member_r`=?  AND `date_req` IN ($date_req)  ");
    ...
    function  cancel_order($id,$n_bill,$id_member_r=0)
    {
        ...
        $stmt = $this->db->prepare("UPDATE  `cart_shop` SET `cancel`=1 ,`date_cancel`=? WHERE   `accountant` = 1 AND `user_direct` = ? AND  number_bill =?   ");
        ...
        if ($stmt->rowCount() >0)
        {
			...
			$stmt1 = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`dollar_exchange` FROM `cart_shop` WHERE    `accountant` = 1 AND `user_direct` = ? AND  number_bill =?   GROUP BY `id_item`,`size`,`table`,`code`,`user_direct`, number_bill ");
            ...
            while ($row = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                ...
                $trace = new trace(); $trace->addtrace('cart_shop','الغاء الطلب من قبل المحاسب المباشر  او المجهز المباشر بعد المحاسبة والتجهيز - رقم الفاتورة '.$n_bill,json_encode($oldData),json_encode($newData),'الغاء الطلب من قبل المحاسب المباشر  او المجهز المباشر  بعد المحاسبة والتجهيز ',$n_bill);
...
//                    $stmtc->execute(array($row['code'],$row['table']));
            ...
            $stmt = $this->db->prepare("UPDATE `cart_shop` SET `status` = 2  , `buy` = 3 , `date_d_r`= ? , `user_id`=?  WHERE   `user_direct` = ? AND  number_bill =?");
	...
	function check_money_oue_item($table,$code,$id_user)
	{
		...
		if (!is_numeric($id_user)) {
			...
			$stmt_count_n = $this->db->prepare("SELECT  *FROM `cart_shop` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `name_color` = ? AND `number_bill`=?  AND  `prepared`=2 AND `accountant`=1 AND `id`=? LIMIT 1");
    ...
    {
        $stmt = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`date_req`,`mpx`,`number_bill`,`top`,`dollar_exchange` FROM `cart_shop` WHERE `user_direct` =?  AND  `number_bill` =? AND `accountant`=1 GROUP BY  `id_item`,`table`,`code`,`number_bill`,price_type,id_offer   ORDER BY `id` DESC  ");
    ...
    {
        $stmt = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`date_req`,`mpx`,`number_bill`,`top`,`dollar_exchange` FROM `cart_shop` WHERE `id_member_r` =?  AND  `number_bill` =? AND `accountant`=1 GROUP BY  `id_item`,`table`,`code`,`number_bill`,price_type,id_offer   ORDER BY `id` DESC  ");
        $stmt->execute(array($id,$n_b));
        return $stmt;
    }
    ...
    function loadmore()
    {
		...
		if (   time() >= strtotime(date('Y-m-d').' 12:00:00 am')  &&  time()  < $toTime && $this->setting->get('hour') !=0 )
		{
			if ($this->admin($this->userid))
			{
				$stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `accountant` = 1 AND `prepared` = 2 AND  done_direct =1 AND  ( `direct` =2  OR direct=0 )  AND `cancel`=0 AND date_prepared between  ? AND  ? GROUP BY `id_member_r`  ORDER BY `number_bill` DESC LIMIT $limit OFFSET $offset");
				$stmt->execute(array($backDay,$toDate));

			}else{
				$stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `accountant` = 1 AND `prepared` = 2 AND  done_direct =1 AND  ( `direct` =2  OR direct=0 )   AND  (`user_direct` =? OR direct=0 )  AND `cancel`=0  AND date_prepared between ? AND  ? GROUP BY `id_member_r`  ORDER BY `number_bill` DESC LIMIT $limit OFFSET $offset");
    ...
    function loadmore3()
    {
		...
		if (   time() >= strtotime(date('Y-m-d').' 12:00:00 am')  &&  time()  < $toTime && $this->setting->get('hour') !=0 )
		{
			if ($this->admin($this->userid))
			{
				$stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `accountant` = 1 AND `prepared` = 2 AND  done_direct =1 AND (  `direct` =3 OR `direct` = 0   )   AND `cancel`=0 AND `date_prepared` between ? AND  ? GROUP BY `id_member_r`   ORDER BY `number_bill` ASC LIMIT $limit OFFSET $offset");
				$stmt->execute(array($backDay,$toDate));

			}else{
				$stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `accountant` = 1 AND `prepared` = 2 AND  done_direct =1 AND   (  `direct` =3 OR `direct` = 0   )   AND `cancel`=0   AND ( `user_direct`=? OR  `direct` = 0 ) AND date_prepared between  ? AND  ? GROUP BY `id_member_r`  ORDER BY `number_bill` ASC LIMIT $limit OFFSET $offset");
				$stmt->execute(array($this->userid,$backDay,$toDate));
    ...
    {
        $stmt = $this->db->prepare("SELECT  * FROM `cart_shop` WHERE `id_member_r` =?  AND  `prepared`=2   AND `cancel`=0  AND (  `direct` =3 OR `direct` = 0   )    GROUP BY   `number_bill`  ORDER BY `date` DESC   ");
    ...
    {
        $stmt = $this->db->prepare("SELECT   * FROM `cart_shop` WHERE `id_member_r` =?  AND  `prepared`=2   AND `cancel`=0  AND `direct`=2 GROUP BY   `number_bill`  ORDER BY `id` DESC   ");
    ...
    {
        $stmt = $this->db->prepare("SELECT  cart_shop.*,SUM(`number`)as number  FROM `cart_shop` WHERE `id_member_r` =?  AND   `prepared` = 2     AND `number_bill`= ? GROUP BY `id_item`,`table`,`code`,`number_bill`,price_type  ORDER BY `id` DESC  ");
        $stmt->execute(array($id_member_r,$number_bill));
        return $stmt;
    }
    ...
    {
        $stmt = $this->db->prepare("SELECT  `date_req` ,`why_rejected`,`date_d_r`  FROM `{$this->cart_shop}` WHERE `id_member_r` =?  AND   `buy` = 3 AND `status` =2  GROUP BY `date_d_r`  ORDER BY `date_req` DESC ");
        $stmt->execute(array($id_member_r));
        return $stmt;
    }
    ...
    {
        $stmt = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`date_req`,`mpx` FROM `{$this->cart_shop}` WHERE `id_member_r` =?  AND   `buy` = 3 AND `status` =2 AND `date_d_r`= ?  GROUP BY `id_item`,`table`,`code`,`date_d_r` ORDER BY `id` DESC  ");
    ...
    function tajhezxxx()
    {
        ...
        $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1, `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ?  , `user_direct`=?, `serial`=? WHERE `id`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=?  ");
    ...
    function tajhez($id_user,$code,$number_bill,$back=0)
    {
        ...
        if ( $this->setting->get('prepared_serial_or_code',0) == 0 || $back==1){
        $stmt=$this->db->prepare("SELECT id,id_member_r,id_item,`table`,SUM(number) as number,name_color FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=?  AND `prepared`=1 GROUP BY  code ,name_color HAVING COUNT(number)=COUNT(*)");
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if ($stmt_serial->rowCount() > 0)
            {
				...
				if($stmt_location->rowCount() > 0) {
                    ...
                    $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1, `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill`=?  AND `accountant`=1  ");
                ...
                if ($stmt2->rowCount() > 0) {
                    ...
                    $trace = new trace(); $trace->addtrace('cart_shop','تجهيز مواد الفاتورة من قبل المجهز المباشر',json_encode($oldData),json_encode($newData),'  تجهيز الفاتورة رقم ' . $number_bill,$number_bill);
        ...
        }else
        {
            ...
            if ($stmtpage->rowCount() > 0) {
                ...
                $stmt=$this->db->prepare("SELECT  * FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=?  AND `prepared`=1  ");
                $stmt->execute(array($id_user,$code,$number_bill));
                if ($stmt->rowCount() > 0) {
            ...
            if ($stmtpage->rowCount() > 0) {
                ...
                $result = $stmtpage->fetch(PDO::FETCH_ASSOC);
                $code = $result['code'];
                $this->tajhez($id_user,$code,$number_bill,1);
...
/*
        ...
        $stmtAllcode=$this->db->prepare("SELECT `table`,code,name_color,id_member_r FROM `cart_shop` WHERE  number_bill=? AND `prepared`=1  AND `table` IN ({$thisModel})  GROUP BY   `id_item`,`table`,`code`,`number_bill`,price_type,id_offer    ");
    ...
    function location()
    {
        ...
        $stmt=$this->db->prepare("SELECT   cart_shop.*, SUM(`number`)as number  FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=? AND `prepared` = 1 ");
        $stmt->execute(array($id_user,$code,$number_bill));
        if ($stmt->rowCount() > 0) {
            $result=$stmt->fetch(PDO::FETCH_ASSOC);
			...
			if($numberOrder <= $checkx)
			{
                ...
                if ($passLocation) {
                    ...
                    $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1, `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,location=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill`=?  AND `accountant`=1  ");
                    ...
                    if ($stmt2->rowCount() > 0) {
                        ...
                        $trace = new trace();
                        $trace->addtrace('cart_shop', 'مجهز مباشر - تجهيز الفاتورة ' . $number_bill, json_encode($oldData), json_encode($newData), ' تجهيز الفاتورة بعد المحاسبة من قبل محاسب الكاشير -بستخدام الموقع ولسيريل', $number_bill);
...
/*
    function enter_serial()
    {
        ...
        $stmt=$this->db->prepare("SELECT  `id`, `id_item`,`size`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number ,`dollar_exchange`   FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=?");
        $stmt->execute(array($id_user,$code,$number_bill));
        if ($stmt->rowCount() > 0) {
            $result=$stmt->fetch(PDO::FETCH_ASSOC);
            ...
            if ($c_serial =="true")
            {
                ...
                if (isset($_POST['location'])) {
					...
					if($numberOrder <= $checkx)
					{
						...
						$stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1, `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,serial=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill`=? AND `accountant`=1");
						...
						if ($stmt2->rowCount() > 0) {
							...
							$trace = new trace(); $trace->addtrace('cart_shop','مجهز مباشر - تجهيز الفاتورة '.$number_bill,json_encode($oldData),json_encode($newData),' تجهيز الفاتورة بعد المحاسبة من قبل محاسب الكاشير -بستخدام الموقع ولسيريل',$number_bill);
							echo $code;
						}
                    ...
                    if ($stmt2->rowCount() > 0) {
                        ...
                        $trace = new trace(); $trace->addtrace('cart_shop','مجهز مباشر - تجهيز الفاتورة '.$number_bill,json_encode($oldData),json_encode($newData),' تجهيز الفاتورة بعد المحاسبة من قبل محاسب الكاشير - استخدم موقع المادة',$number_bill);
...
//                                    echo 'hide_location#'.$result['table'];//  الكمية المطلوبة امبر من الموجودة في   الموقع
                            ...
                            if ($passLocation) {
                                ...
                                $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`serial`=?,`enter_serial`=?,location=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=?  AND `number_bill`=?  AND `accountant`=1 AND `prepared`=1 ");
                                ...
                                $trace = new trace();
                                $trace->addtrace('cart_shop', 'تجهيز الفاتورة', json_encode($oldData), json_encode($newData), ' تجهيز عناصر الفاتورة من قبل المجهز  المباشر ', $number_bill);
...
//					echo 'notFoundSerial';
			...
			}else  if (isset($_POST['serial']))
			{
				...
				if ($c_serial =="true")
				{
					...
					$stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`serial`=?,`enter_serial`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill`=?  AND `accountant`=1 AND `prepared`=1 ");
					...
					if ($stmt2->rowCount() > 0) {
						...
						$trace = new trace(); $trace->addtrace('cart_shop','تجهيز الفاتورة',json_encode($oldData),json_encode($newData),' تجهيز عناصر الفاتورة من قبل المجهز بستخدام السيريال ',$number_bill);
...
//                            echo 'hide_location#'.$result['table'];//  الكمية المطلوبة امبر من الموجودة في   الموقع
                    ...
                    if ($passLocation) {
                        ...
                        $stmt_enter_serial = $this->db->prepare("UPDATE `cart_shop` SET    `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`enter_serial`=? ,location=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill`=?  AND `accountant`=1 AND `prepared`=1 ");
                        ...
                        if ($stmt_enter_serial->rowCount() > 0) {
                            ...
                            $trace = new trace();
                            $trace->addtrace('cart_shop', 'تجهيز الفاتورة', json_encode($oldData), json_encode($newData), ' تجهيز عناصر الفاتورة من قبل المجهز بستخدام السيريال ', $number_bill);
...
//                    echo 'not_enough#'.$result['table'];//  الكمية المطلوبة امبر من الموجودة في   الموقع
				...
				$stmt_enter_serial = $this->db->prepare("UPDATE `cart_shop` SET    `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`enter_serial`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill`=?  AND `accountant`=1 AND `prepared`=1 ");
				...
				if ($stmt_enter_serial->rowCount() > 0) {
					...
					$trace = new trace(); $trace->addtrace('cart_shop','تجهيز الفاتورة',json_encode($oldData),json_encode($newData),' تجهيز عناصر الفاتورة من قبل المجهز  المباشر   ',$number_bill);
    ...
    function tajhez3xxx()
    {
        ...
        $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1, `buy` = 2 ,  `prepared` = 2 ,accountant=1,date_accountant=? ,`date_prepared`= ?  , `user_direct`=?, `serial`=? WHERE `id`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill` = ?  ");
	...
	function tajhez3($id_user,$code,$number_bill,$back=0)
	{
		...
		$accountant=false;
		$stmtCh_acco = $this->db->prepare("SELECT *FROM `cart_shop` WHERE id_member_r=? AND  `code` = ?  AND  `number_bill`=?  AND `accountant`=1  ");
		...
		if($stmtCh_acco->rowCount()>0)
		{
			...
			$stmt = $this->db->prepare("SELECT   id,id_member_r,id_item,`table`,SUM(number) as number,name_color FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=? AND `prepared`=1 AND (`accountant`=0 OR `accountant`=1) GROUP BY  code ,name_color HAVING COUNT(number)=COUNT(*)");
			$stmt->execute(array($id_user, $code, $number_bill));
			if ($stmt->rowCount() > 0) {
				$result = $stmt->fetch(PDO::FETCH_ASSOC);
				$table = $result['table'];
				...
				if ($stmt_serial->rowCount() > 0) {
					...
					if($stmt_location->rowCount() > 0) {
						...
						if ($stmt2->rowCount() > 0) {
							...
							$trace = new trace();
							$trace->addtrace('cart_shop', 'تجهيز الطلب من قبل المحاسب المباشر  - تجهيز الفاتورة ' . $number_bill, json_encode($oldData), json_encode($newData), '  تجهيز الطلب من قبل المحاسب المباشر',$number_bill);
            ...
            if ($stmtpage->rowCount() > 0) {
                ...
                $result = $stmtpage->fetch(PDO::FETCH_ASSOC);
                $code = $result['code'];
                $this->tajhez3($id_user,$code,$number_bill,1);
        ...
        while ($rowx=$stmtAllcode->fetch(PDO::FETCH_ASSOC))
        {
            ...
            if ($rowx['table']=='accessories')
            {
                ...
                if ($stmt_ch_code->rowCount() > 0)
                {
                    $this->tajhez3($rowx['id_member_r'],$rowx['code'],$number_bill);
                    $xcode=true;
                }
                break;
            }else
    ...
    function location3()
    {
		...
		$stmtCx=$this->db->prepare("SELECT *FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=? AND `prepared`=1 AND  (`accountant`=0 OR `accountant`=1)");
		$stmtCx->execute(array($id_user,$code,$number_bill));
		if ($stmtCx->rowCount() > 0) {
			$stmt = $this->db->prepare("SELECT  cart_shop.*,SUM(`number`)as number  FROM `cart_shop` WHERE id_member_r=? AND `code`=? AND `number_bill`=?");
			$stmt->execute(array($id_user, $code, $number_bill));
			if ($stmt->rowCount() > 0) {
				$result = $stmt->fetch(PDO::FETCH_ASSOC);
				$table = $result['table'];
				...
				if ($numberOrder <= $checkx) {
                    ...
                    if ($passLocation) {
                        ...
                        if ($stmt2->rowCount() > 0) {
                            ...
                            $trace = new trace();
                            $trace->addtrace('cart_shop', 'تجهيز الطلب من قبل المحاسب المباشر  - تجهيز الفاتورة ' . $number_bill, json_encode($oldData), json_encode($newData), '  تجهيز الطلب من قبل المحاسب المباشر استخدام مواقع المواد', $number_bill);
...
/*
    function enter_serial3()
    {
		...
		$accountant=false;
		$stmtCh_acco = $this->db->prepare("SELECT *FROM `cart_shop` WHERE id_member_r=? AND  `number_bill`=?  AND `accountant`=1 GROUP BY number_bill");
					...
					if (isset($_POST['location'])) {
						...
						if ($stmt_location->rowCount() > 0) {
							...
							if ($numberOrder > $numberLocation) {
								...
								if($accountant)
								{
									$stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1, `buy` = 2 ,  `prepared` = 2 , `date_prepared`= ?  , `user_direct`=?,`serial`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill` = ?  ");
									$stmt2->execute(array( time(), $this->userid, $serial, $code, $id_user, $table, $result['id_item'], $number_bill));
								}else{
									$stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `id_accountant_user`=?,`done_direct` = 1, `buy` = 2 ,  `prepared` = 2 ,accountant=1 ,date_accountant=? , `date_prepared`= ?  , `user_direct`=?,`serial`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=? AND `number_bill` = ?  ");
								...
								if ($stmt2->rowCount() > 0) {
									...
									$trace = new trace();
									$trace->addtrace('cart_shop', 'تجهيز الطلب من قبل المحاسب المباشر  - تجهيز الفاتورة ' . $number_bill, json_encode($oldData), json_encode($newData), '  تجهيز الطلب من قبل المحاسب المباشر بستخدام الموقع',$number_bill);
						...
						if ($stmt2->rowCount() > 0) {
							...
							$trace = new trace();
							$trace->addtrace('cart_shop', 'تجهيز الطلب من قبل المحاسب المباشر  - تجهيز الفاتورة ' . $number_bill, json_encode($oldData), json_encode($newData), '  تجهيز الطلب من قبل المحاسب المباشر بستخدام الموقع والسيريال',$number_bill);
					...
					if ($c_serial == "true") {
						...
						if (isset($_POST['location'])) {
							...
							if ($numberOrder <= $checkx) {
                                ...
                                if ($passLocation) {
                                    $location = array_unique(array_merge(explode(',', $result['location']), $location), SORT_REGULAR); // التجهيز الذكي
                                    $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET     `done_direct` = 1,`buy` = 2 ,  `prepared` = 2 ,  `date_prepared`= ? , `user_direct`=?,`serial`=?,`enter_serial`=? ,location=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=?  AND `number_bill`=?  AND `accountant`=1");
                                    $stmt2->execute(array(time(), $_SESSION['userid'], $serial, $enter_serial, implode(',', $location), $code, $id_user, $table, $result['id_item'], $number_bill));

                                    if ($stmt2->rowCount() > 0) {

                                        $this->Add_to_sync_schedule($code, $table,'quantity_adjustment',' ','controllers\direct\direct.php 4744 '.$this->UserInfo($this->userid));
                                        $stmtt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE `number_bill`=?");
                                        $stmtt->execute(array($number_bill));
                                        $newData = array();
                                        while ($rowt = $stmtt->fetch(PDO::FETCH_ASSOC)) {
...
//						echo 'notFoundSerial#';
					...
					if ($c_serial == "true") {
						...
						while ($rowt = $stmtt->fetch(PDO::FETCH_ASSOC)) {
							...
							$stmt2 = $this->db->prepare("UPDATE `cart_shop` SET   `done_direct` = 1,`buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`serial`=?,`enter_serial`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=?  AND `number_bill`=?  AND `accountant`=1");
							$stmt2->execute(array(time(), $_SESSION['userid'], $serial, $enter_serial, $code, $id_user, $table, $result['id_item'], $number_bill));

						if ($stmt2->rowCount() > 0) {

                            $this->Add_to_sync_schedule($code,$table,'quantity_adjustment',' ',' controllers\direct\direct.php 4796 '.$this->UserInfo($this->userid));
							$stmtt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE `number_bill`=?");
							$stmtt->execute(array($number_bill));
							$newData = array();
							while ($rowt = $stmtt->fetch(PDO::FETCH_ASSOC)) {
					...
					if ($numberOrder <= $checkx) {
                        ...
                        if ($passLocation) {
                            ...
                            $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET    `done_direct` = 1,`buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`enter_serial`=? ,location=?    WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=?  AND `number_bill`=? AND `accountant`=1 ");
...
//                        echo 'not_enough#'.$result['table'];//  الكمية المطلوبة امبر من الموجودة في   الموقع
					...
					while ($rowt = $stmtt->fetch(PDO::FETCH_ASSOC)) {
						...
						$stmt2 = $this->db->prepare("UPDATE `cart_shop` SET     `done_direct` = 1,`buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=?,`enter_serial`=? WHERE `code`=? AND `id_member_r` =? AND `table` = ? AND `id_item`=?  AND `number_bill`=?  AND `accountant`=1");
	...
	function tajhez3Backto()
    {
        ...
        $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET   `done_direct` = 1 ,`buy` = 2 ,  `prepared` = 2 , `date_prepared`= ? , `user_direct`=? WHERE `id_member_r` =? AND `number_bill` = ? AND `accountant` = 1   ");
    ...
    function tajhez31()
    {
        ...
        $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET   `back_to`=1, `user_direct`=? WHERE `id_member_r` =? AND `number_bill` = ?   ");
    ...
    function tajhez32()
    {
        ...
        $stmt2 = $this->db->prepare("UPDATE `cart_shop` SET   `back_to`=2, `user_direct`=? WHERE `id_member_r` =? AND `number_bill` = ?   ");
        $stmt2->execute(array( $this->userid, $id_user,$number_bill));
        if ($stmt2->rowCount() > 0) {
             echo 1;
        } else {
    ...
    function return_order_minus($table,$code,$id_user,$prepared=1)
    {
        ...
        if ($this->handleLogin()) {
            ...
            $stmt_count_n = $this->db->prepare("SELECT  *FROM `{$this->cart_shop}` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?    AND `buy` = ? AND `number` = 1 AND `prepared`=?  AND `number_bill`=?");
            ...
            if ($stmt_count_n->rowCount() > 0 )
            {
				...
				$stmt_retrieve_item=$this->db->prepare("SELECT *FROM `cart_shop` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `number_bill` = ? AND `buy` = ? AND `prepared`=?   ");
                ...
                $stmt_delete_last_one = $this->db->prepare("SELECT SUM(`number`)as number  FROM `{$this->cart_shop}` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?    AND `buy` = ? AND `prepared`=? AND `number_bill`=? ");
                ...
                if ($number == 1) {
                    ...
                    $stmt = $this->db->prepare("DELETE   FROM `{$this->cart_shop}` WHERE `table` =?  AND `code` =? AND `id_member_r` = ?  AND `buy` = ? AND `prepared`=? AND `number_bill`=?  LIMIT 1 ");
                    $stmt->execute(array($table, $code, $id_user,$buy,$prepared,$number_bill));


                }else if ($number > 1)
                {
                    $stmt_sel = $this->db->prepare("UPDATE  `cart_shop` SET  `number`=`number` - 1  WHERE `table` =?  AND `code` =? AND `id_member_r` = ?   AND `buy` = ?  AND number > 1 AND `prepared`=? AND `number_bill`=? LIMIT  1  ");
                ...
                if ($prepared == 2)
                {
                    $trace = new trace(); $trace->addtrace('cart_shop',' استرجاع مادة من  الطلب من قبل المجهز المباشر بعد المحاسبة والتجهيز -رقم الفاتورة' .$number_bill,json_encode($oldData),json_encode($newData), 'استرجاع مادة من قبل المجهز المباشر',$number_bill);

                }else{
                    $trace = new trace(); $trace->addtrace('cart_shop',' استرجاع مادة من  الطلب من قبل المجهز المباشر-رقم الفاتورة' .$number_bill,json_encode($oldData),json_encode($newData), 'استرجاع مادة من قبل المجهز المباشر',$number_bill);
            ...
            } else
            {
				...
				/*  trace Accountant Minus  */
				$stmt_retrieve_item=$this->db->prepare("SELECT *FROM `cart_shop` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `number_bill` = ? AND `buy` = ? AND `prepared`=?   LIMIT  1  ");
				$stmt_retrieve_item->execute(array($table, $code, $id_user,$number_bill,$buy,$prepared));
				$resultRI=$stmt_retrieve_item->fetch(PDO::FETCH_ASSOC);
				$accountant=new Accountant();
                if ( $_SESSION['direct'] == 3)
            ...
            $stmt2 = $this->db->prepare("SELECT  SUM(`number`)as number  FROM `{$this->cart_shop}` WHERE `table` =?  AND `code` =? AND `id_member_r` = ?   AND `buy`= ?  AND    `prepared`=? AND `number_bill`=? GROUP BY `id_item`,`size`,`table`,`code`  ORDER BY `id`  DESC  ");
            ...
            if ($stmt2->rowCount() > 0) {
				...
				$stmt_up=$this->db->prepare("UPDATE  `cart_shop` SET    edit_bill=1   WHERE  `number_bill` =? AND `code`=?");
    ...
    function return_order_plus($table,$code,$id_user,$id_row)
    {
        ...
        if ($this->handleLogin()) {
            ...
            $tmt_plus=$this->db->prepare("SELECT *FROM `cart_shop` WHERE `table` =?  AND `code` =? AND `id_member_r` = ? AND  `name_color` = ? AND `id`=? AND `number_bill`=? AND `buy` = 1 " );
            ...
            $r=$this->db->insert('cart_shop',$data);
			$stmt_up=$this->db->prepare("UPDATE  `cart_shop` SET    edit_bill=1   WHERE  `number_bill` =? AND `code`=?");
			$stmt_up->execute(array($number_bill,$code));
			$this->edit_bill($number_bill,$this->userid);
            ...
            if ($r) {
                ...
                $trace = new trace(); $trace->addtrace('cart_shop','  اضافة مادة الى  الطلب من قبل المجهز المباشر-رقم الفاتورة' .$number_bill,json_encode($oldData),json_encode($newData), 'اضافة مادة الى قبل المجهز المباشر',$number_bill);



                $stmt2 = $this->db->prepare("SELECT SUM(`number`)as number  FROM `{$this->cart_shop}` WHERE `table` =?  AND `code` =? AND `id_member_r` = ? AND `name_color`=? AND `buy`= 1 GROUP BY `id_item`,`size`,`table`,`code` ORDER BY `id`  DESC  ");
    ...
    function return_order_minus3($table,$code,$id_user)
    {
        ...
        if ($this->handleLogin()) {
			...
			$countBill=0;
			$stmtCountNumberBillForClear = $this->db->prepare("SELECT COUNT(number_bill) as bill , SUM(number) as num FROM `cart_shop` WHERE  `number_bill`=?   ");
            ...
            $stmt = $this->db->prepare("SELECT  * FROM `cart_shop` WHERE `id_member_r` =?    AND `number_bill`=? AND `table`=? AND `code`=? GROUP BY  `id_item`,`table`,`code`,`number_bill`,price_type,id_offer   LIMIT 1 ");
			...
			$stmt_count_n = $this->db->prepare("SELECT  *FROM `{$this->cart_shop}` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `name_color` = ? AND `number_bill`=?    AND `buy` = 1 AND `number` = 1 AND `prepared`=1  AND `accountant`=1");
            ...
            if ($stmt_count_n->rowCount() > 0 )
            {
				...
				/*  trace Accountant Minus  */
				$stmt_retrieve_item=$this->db->prepare("SELECT *FROM `cart_shop` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `name_color` = ? AND `number_bill` = ? AND `buy` = 1 AND `prepared`=1 LIMIT  1 ");
               ...
               $stmt_delete_last_one = $this->db->prepare("SELECT SUM(`number`)as number  FROM `{$this->cart_shop}` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `name_color` = ? AND `number_bill`=?    AND `buy` = 1 AND `prepared`=1  AND `accountant`=1 ");
                $stmt_delete_last_one->execute(array($table, $code, $id_user,$color,$number_bill));
                $number= $stmt_delete_last_one->fetch(PDO::FETCH_ASSOC)['number'];

                if ($number == 1) {

                    $stmt = $this->db->prepare("DELETE   FROM `{$this->cart_shop}` WHERE `table` =?  AND `code` =? AND `id_member_r` = ?  AND `name_color` = ? AND `number_bill`=?  AND `buy` = 1 AND `prepared`=1   AND `accountant`=1 LIMIT 1 ");
                    $stmt->execute(array($table, $code, $id_user,$color,$number_bill));

					$flag=1;
                }else if ($number > 1)
                {
                    $stmt_sel = $this->db->prepare("UPDATE  `cart_shop` SET  `number`=`number` - 1  WHERE `table` =?  AND `code` =? AND `id_member_r` = ?  AND `name_color` = ? AND `number_bill`=?   AND `buy` = 1  AND number > 1 AND `prepared`=1 AND `accountant`=1 LIMIT  1  ");
                ...
                $trace = new trace(); $trace->addtrace('cart_shop',' استرجاع مادة من  الطلب من قبل المحاسب المباشر قبل  المحاسبة والتجهيز -رقم الفاتورة' .$number_bill,json_encode($oldData),json_encode($newData), 'استرجاع مادة من قبل المحاسب المباشر',$number_bill);
            ...
            if($flag==1) {
					...
					$stmt2 = $this->db->prepare("SELECT  SUM(`number`)as number  FROM `cart_shop` WHERE `table` =?  AND `code` =? AND `id_member_r` = ?  AND `name_color` = ? AND `buy`= 1  AND `prepared`=1 GROUP BY `id_item`,`size`,`table`,`code`,`name_color` ORDER BY `id`  DESC  ");
					$stmt2->execute(array($table, $code, $id_user, $color));
					$res = $stmt2->fetch(PDO::FETCH_ASSOC);
    ...
    function return_order_plus3($table,$code,$id_user,$id_row)
    {
        ...
        if ($this->handleLogin()) {
            ...
            if ($r) {
                ...
                $trace = new trace(); $trace->addtrace('cart_shop','  زيادة مادة الى  الطلب من قبل المحاسب المباشر-رقم الفاتورة' .$number_bill,json_encode($oldData),json_encode($newData), 'زيادة  مادة الى الطلب من قبل المحاسب  المباشر',$number_bill);
    ...
    function return_order_minus3After_pay($table,$code,$id_user)
    {
        ...
        if ($this->handleLogin()) {
			...
			$stmt_count_n = $this->db->prepare("SELECT  *FROM `{$this->cart_shop}` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `name_color` = ? AND `number_bill`=?    AND `buy` = 2 AND `number` = 1 AND `prepared`=2 AND `accountant`=1");
            $stmt_count_n->execute(array($table, $code, $id_user,$color,$number_bill));
            ...
            if ($stmt_count_n->rowCount() > 0 )
            {
                ...
                $stmt_delete_last_one = $this->db->prepare("SELECT SUM(`number`)as number  FROM `{$this->cart_shop}` WHERE  `table` =?  AND `code` =? AND `id_member_r` = ?   AND `name_color` = ? AND `number_bill`=?    AND `buy` = 2 AND `prepared`=2  AND `accountant`=1  ");
                $stmt_delete_last_one->execute(array($table, $code, $id_user,$color,$number_bill));
                $number= $stmt_delete_last_one->fetch(PDO::FETCH_ASSOC)['number'];

                if ($number == 1) {
                    $this->setAmountEmployDirect3($id_row,$number_bill);
                    $stmt = $this->db->prepare("DELETE   FROM `{$this->cart_shop}` WHERE `table` =?  AND `code` =? AND `id_member_r` = ?  AND `name_color` = ? AND `number_bill`=?  AND `buy` = 2 AND `prepared`=2  AND `accountant`=1  LIMIT 1 ");
                    $stmt->execute(array($table, $code, $id_user,$color,$number_bill));
					$flag=1;
                ...
                {
                    $stmt_sel = $this->db->prepare("UPDATE  `cart_shop` SET  `number`=`number` - 1  WHERE `table` =?  AND `code` =? AND `id_member_r` = ?  AND `name_color` = ? AND `number_bill`=?   AND `buy` = 2  AND number > 1 AND `prepared`=2  AND `accountant`=1 LIMIT  1  ");
                    $stmt_sel->execute(array($table, $code, $id_user,$color,$number_bill));
                    if ($stmt_sel->rowCount() < 1)
                    {
                        $this->setAmountEmployDirect3($id_row,$number_bill);
                ...
                $trace = new trace(); $trace->addtrace('cart_shop',' استرجاع مادة من  الطلب من قبل المحاسب المباشر بعد  المحاسبة والتجهيز -رقم الفاتورة' .$number_bill,json_encode($oldData),json_encode($newData), 'استرجاع مادة من قبل المحاسب المباشر',$number_bill);
            ...
            if ($flag==1) {
                ...
                $stmttIdItem=$this->db->prepare("SELECT id_item FROM `cart_shop` WHERE `number_bill` = ? AND id_member_r=?");
    ...
    function setAmountEmployDirect3($id,$n_b)
    {
        ...
        $stmtd = $this->db->prepare("SELECT * FROM `cart_shop` WHERE `id` =? AND `number_bill`=? AND user_direct =? ");
	...
	function add_item_to_order($id_member_r)
	{
		...
		if ($this->handleLogin()) {
			...
			if (!empty($_POST['id_device'])) {
                ...
                $stmtt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE  `number_bill` = ? AND  id_member_r=? ");
				...
				$trace = new trace();
				$trace->addtrace('cart_shop', 'اضافة مادة الى الطلب - رقم الفاتورة ' . $number_bill, json_encode($oldData), json_encode($newData), 'اضافة مادة الى الطلب - رقم الفاتورة ' . $number_bill, $number_bill);
				$this->edit_bill($number_bill,$this->userid);
	...
	function checkNewItemInBill($id,$id_item,$number_bill)
	{
		...
		$stmt=$this->db->prepare("SELECT *FROM `cart_shop` WHERE id_member_r=? AND id_item=? AND number_bill=? AND edit_bill=1 AND accountant=?");
    ...
    function  search()
    {
        if ($this->handleLogin())
        {
            ...
            $search = strip_tags(trim($_GET['value']));
            $q = '%' . $search . '%';
			$stmt = $this->db->prepare("SELECT register_user.id,register_user.name,register_user.phone  FROM `register_user` inner join cart_shop on cart_shop.id_member_r=register_user.id WHERE ( register_user.name LIKE ? OR  register_user.phone LIKE ? ) AND  cart_shop.accountant =1   AND cart_shop.cancel=0 GROUP BY cart_shop.id_member_r LIMIT 15");
	...
	function  searchActive()
	{
		if ($this->handleLogin())
		{
			...
			$search = strip_tags(trim($_GET['value']));
			$q = '%' . $search . '%';
			$stmt = $this->db->prepare("SELECT register_user.id,register_user.name,register_user.phone,cart_shop.user_direct ,cart_shop.number_bill  FROM `register_user` inner join cart_shop on cart_shop.id_member_r=register_user.id WHERE ( register_user.name LIKE ? OR  register_user.phone LIKE ?  OR cart_shop.number_bill=? ) AND  cart_shop.accountant =1 AND (cart_shop.prepared=1 OR  cart_shop.prepared=0 ) AND `table` IN({$c}) AND cart_shop.cancel=0 GROUP BY cart_shop.id_member_r LIMIT 15");
	...
	function  item_review()
	{
		...
		if ($this->handleLogin())
		{
            ...
            $required=null;
            if ( $this->setting->get('required_serial_rewind') == 1)
            {
                $required ='required';
            }
			...
			if ($stmt->rowCount() >0 ) {
				...
				while ($row=$stmt->fetch(PDO::FETCH_ASSOC))
				{
					...
					if ($row['table'] == 'accessories') {
						...
						$excelStmt->execute(array($row['code'],$row['name_color']));
						if ($excelStmt->rowCount() > 0)
						{
							$DPrice=$excelStmt->fetch(PDO::FETCH_ASSOC);
							$row['now_price'] = $this->price_dollarsAdmin($DPrice['price_dollars']) . ' د.ع ';
				...
				foreach ($ids as $id) {
					...
					if ($stmt2->rowCount() > 0) {
						foreach ($idrow[$id] as $key => $idx) {
							$stmt3 = $this->db->prepare("SELECT *FROM cart_shop WHERE `id`= ? LIMIT 1");
							...
							$stmt4->execute(array($id, $idx, $lastID, $result3['id_item'], $result3['title'], $result3['image'], $result3['code'], $result3['number_bill'], $number_bill_new, $price_new, time(), $this->userid, $result3['name_color'], $result3['date'], $note[$id][$key],$note[$id][$key], $location[$id][$key], $result3['table']));
	...
	function processing_request_rejected($id,$number_bill)
	{
		...
		if ($this->handleLogin()) {
			...
			$stmtx = $this->db->prepare("SELECT `id`, `id_item`,`size`,`price`,`price_dollars`,`image`,`color`,`name_color`,`code`,`table`,SUM(`number`)as number,`buy`,`date`,`dollar_exchange` FROM `cart_shop` WHERE `id_member_r` =?  AND  `number_bill` =?  GROUP BY `id_item`,`table`,`code` ");
...
//                    $stmtExcel_conform->execute(array(1,$row['code'],$table,time()));
//
//                }
			...
			$stmt = $this->db->prepare("UPDATE `cart_shop` SET `cancel` = 1  ,`status` = 2  , `buy` = 3, `why_rejected` = ?  , `date_d_r`= ? , `user_id`=?,`id_accountant_user`=?  WHERE  `buy` = ? AND `id_member_r`=? AND `number_bill`=?  ");
			...
			$trace = new trace(); $trace->addtrace('cart_shop','الغاء الطلبمن قبل المحاسب الثانوي',json_encode($oldData),json_encode($newData),$this->userid . 'الغاء طلب ',$number_bill);
	...
	function alixcol3($id_user,$code,$number_bill,$back=0)
	{
		...
		if ($stmt->rowCount() > 0) {
            ...
            if (in_array($result['table'],$this->model_big_q))
            {
                ...
                {
                    echo json_encode(array('code'=>$code,'pass'=>'false'));

                }else
                {
                    echo json_encode(array('code'=>$code,'pass'=>'true'));
            ...
            if ($stmtpage->rowCount() > 0) {
                ...
                $result = $stmtpage->fetch(PDO::FETCH_ASSOC);
                $code = $result['code'];
                $this->alixcol3($id_user,$code,$number_bill,1);
        ...
        while ($rowx=$stmtAllcode->fetch(PDO::FETCH_ASSOC))
        {
            ...
            if ($rowx['table']=='accessories')
            {
                ...
                if ($stmt_ch_code->rowCount() > 0)
                {
                    $this->alixcol3($rowx['id_member_r'],$rowx['code'],$number_bill);
                    $xcode=true;
                }
                break;
            }
	...
	function alixcol($id_user,$code,$number_bill,$back=0)
	{
		...
		}else
		{
            ...
            if ($stmtpage->rowCount() > 0) {
                ...
                $result = $stmtpage->fetch(PDO::FETCH_ASSOC);
                $code = $result['code'];
                $this->alixcol($id_user, $code, $number_bill, 1);
    ...
    function edit_price()
    {
        if ($this->handleLogin()) {
            ...
            if (is_numeric($price)) {
                ...
                $stmtch = $this->db->prepare("SELECT *FROM cart_shop WHERE id_member_r=? AND id_item =? AND number_bill=? AND  `table`=? AND code=? AND name_color=? LIMIT 1");
                ...
                if ($stmtch->rowCount() > 0) {
                    ...
                    $stmtup = $this->db->prepare("UPDATE  cart_shop  SET price_dollars=? ,old_price=?,edit_price=?,user_edit_price=? WHERE id_member_r=? AND id_item =? AND number_bill=? AND  `table`=? AND code=? AND name_color=? ");
                    ...
                    if ($stmtup->rowCount() > 0) {
                        ...
                        $stmtPriceBill= $this->db->prepare("UPDATE  cart_shop  SET edit_price=? WHERE id_member_r=?   AND number_bill=? AND  `table`=?   ");
...
function load_order_acount()
{
        ...
        $stmt = $this->db->prepare("SELECT `cart_shop`.*,register_user.name,register_user.phone ,register_user.id  FROM `cart_shop` INNER JOIN register_user ON register_user.id = cart_shop.id_member_r WHERE   `cart_shop`.`accountant` = 0 AND `cart_shop`.`buy` <> 0 AND `table` IN ({$c})  AND `cart_shop`.`number_bill` <> 0  AND `cart_shop`.`cancel`=0 GROUP BY `cart_shop`.`number_bill`,`cart_shop`.id_member_r  ORDER BY   `cart_shop`.`number_bill` ASC ");
        $stmt->execute();


//        $stmt = $this->db->prepare("SELECT *FROM `cart_shop` WHERE   `user_direct` =?  AND  `accountant` = 1  AND `prepared` = 1 AND  done_direct =0 AND `direct` =3 AND `back_to`=0  GROUP BY `number_bill`  ORDER BY `number_bill` ASC ");
//        $stmt->execute(array($this->userid));
                                ...
                                foreach ($loc as $l)
                                {
                                    ...
                                    if ($l) {
                                        ...
                                        if ($stmt_ch_location->rowCount() > 0) {
                                            $stmtExcel_conform = $this->db->prepare("UPDATE location SET  quantity=quantity+1 ,`date`=?  WHERE code =? AND  model=? AND location=?");
                                            $stmtExcel_conform->execute(array(time(), $row['code'], $tble, $l));
                                        } else {
    ...
    function check_number_bill()
    {
        ...
        $stmt_ch = $this->db->prepare("SELECT COUNT(a) as num_bill FROM (select COUNT(id_member_r) as a FROM cart_shop WHERE number_bill =? AND accountant=0      GROUP BY id_member_r,number_bill) as t;");
        $stmt_ch->execute(array($number_bill));
        $rult = $stmt_ch->fetch(PDO::FETCH_ASSOC);
        if ($rult['num_bill'] > 1) {

            $html='';
            $stmt_custom = $this->db->prepare("SELECT  cart_shop.id_member_r,register_user.name FROM `cart_shop` INNER JOIN register_user ON register_user.id =cart_shop.id_member_r WHERE  cart_shop.number_bill = ? AND  cart_shop.accountant=0    GROUP BY cart_shop.id_member_r ");
    ...
    function pay_bill()
    {
        if ($this->handleLogin()) {
            ...
            if ($id)
            {
                $stmtChAcco = $this->db->prepare("SELECT *FROM  `cart_shop`  WHERE `number_bill` =? AND `id_member_r`=? AND `buy` = 1  AND cancel=0 AND `accountant`=0 ");
                $stmtChAcco->execute(array($number_bill, $id));

            }else
            {
                $stmtChAcco = $this->db->prepare("SELECT *FROM  `cart_shop`  WHERE `number_bill` =?   AND `buy` = 1  AND cancel=0 AND `accountant`=0");
    ...
    function save_note_bill()
    {
        if ($this->handleLogin())
        {
            ...
            $stmt=$this->db->prepare("UPDATE  cart_shop SET  note_prepared=? ,user_note_prepared=? WHERE number_bill=? AND id_member_r=?");
