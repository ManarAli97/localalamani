...
<div class="bar_top" style="padding: 10px;background: #f8f8f8a3;">
    <div class="container">
                ...
                <div class="row align-items-center	">
                    ...
                    <?php if (!$this->isDirect()) { ?>
                        ...
                        <div class="col-auto  d-md-block d-lg-none" style="padding: 0">
                            ...
                            <div class="dropdown">
                                <button   class="btn cart_shop" type="button" id="dropdownMenuButton_car" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="count_item count_item_cartShow"><?php  echo $count ?></span>  <i class="fa fa-cart-arrow-down"></i>
                                </button>
                    ...
                    <?php  }  else{   ?>
                        ...
                        <?php  if (isset($_SESSION['loggedIn'])) {  ?>
                            <div class="col-auto but-name-user" style="padding-top: 5px ; position: relative; margin-right: -20px; margin-left:-15px; margin-bottom:15px">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <?php  if (!isset($_COOKIE['g_active'])) { ?>
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton22" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #7a1a92; border: 1px solid #7a1a92">
                                    ...
                                    <?php if ($_SESSION['direct'] ==2 )  {    ?>
                                        <div class="col-auto">
                                            ...
                                            <style>
                                                .but-name-user{
                                                    padding-top: 5px ; position: relative; margin-right: -45px; margin-left:-12px
                                                }
                                                span.bellOrder {
                                                    margin-right: 6px;
                                                }
        ...
        <li class="nav-item active">
            <a class="nav-link item_menu" href="<?php echo $url ?>">  <i class="fa fa-home" ></i> <span style ="font-size: 19px;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif !important;">الرئيسية</span>  </a>
        </li>
        ...
        <?php if (!empty($category_site_acc_computer)) { ?>
            <li class="nav-item dropdown li_dropdown_menu   ">
                ...
                <a class="nav-link Dropdown_main_menu dropdown-toggle" href="#">      <?php  echo $this->langSite('computer')?>  </a>
                <ul class="dropdown-menu dropdown-menu-right first_sub_menu item_menu " aria-labelledby="navbarDropdownMenuLink1">
                    <?php  foreach ($category_site_acc_computer as $key => $cat_s_t) { ?>
                        <li class="dropdown-submenu rotate_this_active ">
                            <a class="nav-link Dropdown_main_menu computer_menu_hover <?php  echo $cat_s_t['sub'] ?>  "  data-ids="<?php  echo $cat_s_t['id'] ?>" data-sub="0"  href="<?php  echo url ?>/computer/list_view/<?php echo $cat_s_t['id'] ?>" id="navbarDropdownMenuLink1" data-toggle="" aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php  if ($computer->ck_sub_cat_public($cat_s_t['id'])) { ?>
                                <ul class="dropdown-menu dropdown-menu-right first_sub_menu computer_nav_hover<?php  echo $cat_s_t['id'] ?>" aria-labelledby="navbarDropdownMenuLink1">
        ...
        <?php if (!empty($category_camera)) { ?>
            <li class="nav-item dropdown li_dropdown_menu   ">
                ...
                <a class="nav-link Dropdown_main_menu dropdown-toggle" href="#">      <?php  echo $this->langSite('camera')?>  </a>
                <ul class="dropdown-menu dropdown-menu-right first_sub_menu item_menu " aria-labelledby="navbarDropdownMenuLink1">
                    <?php  foreach ($category_camera as $key => $cat_s_t) { ?>
                        <li class="dropdown-submenu rotate_this_active ">
                            <a class="nav-link Dropdown_main_menu camera_menu_hover  <?php  echo $cat_s_t['sub'] ?>  "  data-ids="<?php  echo $cat_s_t['id'] ?>" data-sub="0"  href="<?php  echo url ?>/camera/list_view/<?php echo $cat_s_t['id'] ?>" id="navbarDropdownMenuLink1" data-toggle="" aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php  if ($camera->ck_sub_cat_public($cat_s_t['id'])) { ?>
                                <ul class="dropdown-menu dropdown-menu-right first_sub_menu camera_nav_hover<?php  echo $cat_s_t['id'] ?>" aria-labelledby="navbarDropdownMenuLink1">
                                </ul>
                            <?php } ?>
                        </li>
        ...
        <?php if (!empty($category_network)) { ?>
            <li class="nav-item dropdown li_dropdown_menu   ">
                ...
                <a class="nav-link Dropdown_main_menu dropdown-toggle" href="#">      <?php  echo $this->langSite('network')?>  </a>
                <ul class="dropdown-menu dropdown-menu-right first_sub_menu item_menu " aria-labelledby="navbarDropdownMenuLink1">
                    <?php  foreach ($category_network as $key => $cat_s_t) { ?>
                        <li class="dropdown-submenu rotate_this_active ">
                            <a class="nav-link Dropdown_main_menu network_menu_hover  <?php  echo $cat_s_t['sub'] ?>  "  data-ids="<?php  echo $cat_s_t['id'] ?>" data-sub="0"  href="<?php  echo url ?>/network/list_view/<?php echo $cat_s_t['id'] ?>" id="navbarDropdownMenuLink1" data-toggle="" aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php  if ($network->ck_sub_cat_public($cat_s_t['id'])) { ?>
                                <ul class="dropdown-menu dropdown-menu-right first_sub_menu network_nav_hover<?php  echo $cat_s_t['id'] ?>" aria-labelledby="navbarDropdownMenuLink1">
                                </ul>
                            <?php } ?>
                        </li>
        ...
        <?php if (!empty($category_printing_supplies)) { ?>
            <li class="nav-item dropdown li_dropdown_menu   ">
                ...
                <a class="nav-link Dropdown_main_menu dropdown-toggle" href="#">      <?php  echo $this->langSite('printing_supplies')?>  </a>
                <ul class="dropdown-menu dropdown-menu-right first_sub_menu item_menu " aria-labelledby="navbarDropdownMenuLink1">
                    <?php  foreach ($category_printing_supplies as $key => $cat_s_t) { ?>
                        <li class="dropdown-submenu rotate_this_active ">
                            <a class="nav-link Dropdown_main_menu printing_supplies_menu_hover  <?php  echo $cat_s_t['sub'] ?>  "  data-ids="<?php  echo $cat_s_t['id'] ?>" data-sub="0"  href="<?php  echo url ?>/printing_supplies/list_view/<?php echo $cat_s_t['id'] ?>" id="navbarDropdownMenuLink1" data-toggle="" aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php  if ($printing_supplies->ck_sub_cat_public($cat_s_t['id'])) { ?>
                                <ul class="dropdown-menu dropdown-menu-right first_sub_menu printing_supplies_nav_hover<?php  echo $cat_s_t['id'] ?>" aria-labelledby="navbarDropdownMenuLink1">
                                </ul>
                            <?php } ?>
                        </li>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
    <div id="accordion" class="d-lg-none accordion_all_menu">
...
$(".computer_menu_hover").on("mouseover", function () {
    var ids=$(this).data('ids')
    var sub=$(this).data('sub')
    if (sub === 0){
        $(this).data('sub','1')
        $(".computer_nav_hover"+ids ).html(`<div class="loading_sub_menu"><img src="<?php echo $this->static_file_site ?>/image/site/loding.gif"></div>`);
        $.get( "<?php  echo url ?>/computer/listSubCategoryMenu/"+ids, function( data ) {
            if (data)
            {
                $(".computer_nav_hover"+ids).html( data );
            }
        });
...
$(".camera_menu_hover").on("mouseover", function () {
    var ids=$(this).data('ids')
    var sub=$(this).data('sub')
    if (sub === 0){
        $(this).data('sub','1')
        $(".camera_nav_hover"+ids ).html(`<div class="loading_sub_menu"><img src="<?php echo $this->static_file_site ?>/image/site/loding.gif"></div>`);
        $.get( "<?php  echo url ?>/camera/listSubCategoryMenu/"+ids, function( data ) {
            if (data)
            {
                $(".camera_nav_hover"+ids).html( data );
            }
        });
...
$(".network_menu_hover").on("mouseover", function () {
    var ids=$(this).data('ids')
    var sub=$(this).data('sub')
    if (sub === 0){
        $(this).data('sub','1')
        $(".network_nav_hover"+ids ).html(`<div class="loading_sub_menu"><img src="<?php echo $this->static_file_site ?>/image/site/loding.gif"></div>`);
        $.get( "<?php  echo url ?>/network/listSubCategoryMenu/"+ids, function( data ) {
            if (data)
            {
                $(".network_nav_hover"+ids).html( data );
            }
        });
...
$(".printing_supplies_menu_hover").on("mouseover", function () {
    var ids=$(this).data('ids')
    var sub=$(this).data('sub')
    if (sub === 0){
        $(this).data('sub','1')
        $(".printing_supplies_nav_hover"+ids ).html(`<div class="loading_sub_menu"><img src="<?php echo $this->static_file_site ?>/image/site/loding.gif"></div>`);
        $.get( "<?php  echo url ?>/printing_supplies/listSubCategoryMenu/"+ids, function( data ) {
            if (data)
            {
                $(".printing_supplies_nav_hover"+ids).html( data );
            }
        });
