                ...
                <div class="row align-items-center	">
                    ...
                    <?php if (!$this->isDirect()) { ?>
                        ...
                        <div class="col-auto   d-md-block d-lg-none" style="padding: 0">
                            ...
                            <div class="dropdown">
                                <button   class="btn cart_shop dropdown-toggle" type="button" id="dropdownMenuButton_car" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col">
                ...
                <nav class="navbar navbar-expand-lg navbar-light for_fixed_nav ">
                    ...
                    <div class="dropdown cartDrop_small_fixed">
                        <button   class="btn cart_shop dropdown-toggle" type="button" id="dropdownMenuButton_carFor_fixed" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
