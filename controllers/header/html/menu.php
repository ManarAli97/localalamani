        ...
        <li class="serial_system">  <a href="#" >  <?php  echo $this->langControl('serial_system') ?>  </a>
            ...
            <ul>
                <?php  if ($this->permit('generation_serial','serial_system')) {  ?>
                    <li class="serial_system"> <a  class="serial_system" href="<?php  echo url ?>/serial_system/generation_serial"> <?php  echo  $this->langControl('generation_serial')  ?> </a> </li>
                <?php  } ?>
                ...
                <?php  if ($this->permit('serial_material_inventory','serial_system')) {  ?>
                    <li class="serial_system"><a  class="serial_system" href="<?php  echo url ?>/serial_system/serial_material_inventory"> جرد السيريلات  </a></li>
                <?php  } ?>
