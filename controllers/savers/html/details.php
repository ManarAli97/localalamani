                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-4 col-sm-6 col-6">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <button class="btn   addToCart" type="button"
                                                        data-toggle="modal" data-target="#login_site">
                                                        اضف الى السلة
                                                        <i class="fa fa-cart-plus"></i>
                                                </button>
                                            <?php } ?>
            ...
            <script>
                ...
                $(document).ready(function () {
                    $('#buy_form').submit(function (e) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: '<?php echo url . '/' . $this->folder ?>/car_item/'+id+'/' + $("#count").val(),
                            data: $(this).serialize(),
                ...
                function addToCartCover(id,price_type=0) {
                    var number=1;
                    ...
                    $.get('<?php echo url ?>/savers/cart_order/'+id,{price_type:price_type,number:number}, function(data){
                        if (data !=='finish')
                        {
